...
def define_G(opt):
    ...
    # ----------------------------------------
    # cosr hf_in3con_merge_hf + CAB->ECAB
    # ----------------------------------------
    if net_type == 'hf_in3con_merge_hf_ECAB':
        from models.network_cosr_hf_in3con_merge_hf_ECAB import COSR as net
    ...
    # ----------------------------------------
        ...
        from models.network_cosr_hf_in3con_merge_hf_ECAB_woCor import COSR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    # ----------------------------------------
        ...
        from models.network_cosr_hf_in3con_merge_hf_ECAB_woWave import COSR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
